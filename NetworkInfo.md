# Team 95 2026 season on-robot network notes

## Refer to [WPILIB network address documentation](https://docs.wpilib.org/en/stable/docs/networking/networking-introduction/ip-configurations.html) for more details
...
|------------|--------------------|---------------------|
| 10.0.95.13 |                    |                 |
| 10.0.95.14 | 1st LimeLight 3G   | stern |
| 10.0.95.15 | 2nd LimeLight 3G   | bow   |
